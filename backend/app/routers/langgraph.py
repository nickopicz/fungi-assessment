...
async def build_langgraph(message: str):
    ...
    if "yield rates" in message or "yield" in message or "YR" in message:
    ...
    elif "social feed" in message or "social" in message:
    ...
    elif "historical" in message or "time series" in message:
